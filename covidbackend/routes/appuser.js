...
router.post('/signup', (req, res) => {
    ...
    connection.query('SELECT * FROM appuser WHERE email = ?', [email], (err, results) => {
      if (err) throw err;
      ...
      connection.query('INSERT INTO appuser (name,email, password) VALUES (?,?, ?)', [name,email, password], (err, results) => {
          if (err) {
  ...
  router.post('/login', (req, res) => {
    ...
    connection.query('SELECT * FROM appuser WHERE email = ? AND password = ?', [email, password], (err, results) => {
      if (err) {
